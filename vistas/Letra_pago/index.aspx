...
<asp:Content ID="Content4" ContentPlaceHolderID="letras" Runat="Server">
...
</asp:Content><asp:Content ID="Content5" ContentPlaceHolderID="letras" Runat="Server">
 ...
 <div class="row text-center">
    ...
    <div class="col-sm-4 col-sm-offset-4">
       <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="idletPago" DataSourceID="letradepago">
           <Columns>
               <asp:BoundField DataField="idletPago" HeaderText="idletPago" ReadOnly="True" SortExpression="idletPago" />
               <asp:BoundField DataField="idCredito" HeaderText="idCredito" SortExpression="idCredito" />
               <asp:BoundField DataField="letraPago" HeaderText="letraPago" SortExpression="letraPago" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:erickBD %>" SelectCommand="procLetrasPagoBuscarxCredito" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:RouteParameter Name="id" RouteKey="id" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
